...
Using the quantile representation, compute \(W_1(\mu,\nu)\), and describe what the optimal plan does.
(You may compute the integrals explicitly.)
\end{exercise}
...
Using the fact that the optimal map is affine, show that the displacement interpolation
...
\item Compute the Wasserstein barycenter with equal weights.
\end{enumerate}
