...
Recall our notation involving an observed variable $x$ and a latent variable $z$. In general LVMs, the log-likelihood can be expressed as 
\begin{equation}
    \log p(x|\theta) = \int_\cZ p(x|\theta,z)p(z|\theta)\dz. \label{eq:LVM_LL}
\end{equation}
